...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="GLOBAL_SCU_XMC1" URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0" description="GLOBAL_SCU_XMC1 APP allows to register callback functions and to handle the SR0/SR1/SR2 service request Events." version="4.1.10" minDaveVersion="4.0.0" instanceLabel="GLOBAL_SCU_XMC1_0" appLabel="">
  ...
  <virtualSignals name="sr_irq2" URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0/vs_sr2_signal_in" hwSignal="signal_in" hwResource="//@hwResources.2"/>
  <requiredApps URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0/appres_cpu" requiredAppName="CPU_CTRL_XMC1" requiringMode="SHARABLE">
    <downwardMapList xsi:type="ResourceModel:App" href="../../CPU_CTRL_XMC1/v4_0_8/CPU_CTRL_XMC1_0.app#/"/>
  </requiredApps>
  <hwResources name="NVIC Node 0" URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0/hwres_sr0_scunode" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/sv0" solverVariable="true" mResGrpUri="peripheral/cpu/0/nvic/interrupt/sv0">
  ...
  <hwResources name="NVIC Node 1" URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0/hwres_sr1_scunode" resourceGroupUri="peripheral/cpu/0/nvic/interrupt/sv1" solverVariable="true" mResGrpUri="peripheral/cpu/0/nvic/interrupt/sv1">
  ...
  <hwResources name="NVIC Node 2" URI="http://resources/4.1.10/app/GLOBAL_SCU_XMC1/0/hwres_sr2_scunode" resourceGroupUri="" required="false" solverVariable="true" mResGrpUri="peripheral/cpu/0/nvic/interrupt/sv2">
    <solverVarMap index="5">
